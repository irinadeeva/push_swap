...
echo "❌ - ./checker 0 9 1 8 2 7 3 6 4
...
echo "Leaks: \033[31mvalgrind is unable, check your Makefile or SDL/MLX compilers, or run it as a Daemon.\033[m ⚠"
fi
...
if [ $res -gt 1500 ]
then
echo "Test result on $from..$to randoms: \033[36m$res\033[m ⃣ ❕ ⃣ ❗"
let "sred += $res"
elif [ $res -gt 1300 ]
then
echo "Test result on $from..$to randoms: \033[36m$res\033[m ⃣ ❕ ⃣ ✅"
...
then
echo "Test result on $from..$to randoms: \033[36m$res\033[m 2⃣ ❕ 5⃣ ✅ ✅"
let "sred += $res"
elif
...
if [ $koef -gt 1300 ]
then
echo "\nMiddle value: \033[33m$koef\033[m Grade is : ⃣ ❗"
elif [ $koef -gt 1300 ]
then
echo "\nMiddle value: \033[33m$koef\033[m Grade is : ⃣ ✅"
elif [ $koef -gt 1100 ]
